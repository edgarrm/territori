...
class CuentaLimpiaSeederTest extends TestCase
{
    ...
    public function test_fija_meta_igual_a_lista_nominal_y_cobertura_en_cero(): void
    {
        ...
        $this->assertSame(2, DB::table('metas_seccion')->where('tenant_id', $tenant->id)->count());
        ...
        $this->assertSame(1000, (int) $cobertura->meta);
