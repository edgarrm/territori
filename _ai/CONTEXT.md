...
- **Fase**: 05/06 (SDD + Implementation), Sprint 4 cerrado.
...
- **Pendiente inmediato (Sprint 5)**: Brigadistas (memberships) + asignación de zonas (`brigadista_seccion`) + ratios + límite/facturación por brigadista activo. `brigadistas_activos` del resumen del mapa (hoy `[]`) se poblará aquí.
